...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    mapping(uint => address) registryAddress;
    ...
    function _transfer(
        ...
        IRootRegistry(registryAddress[tokenId]).domainTransfer(to, tokenId);
    ...
    function setRegistry(address registry_,bool val_) external onlyOwner {
        registry[registry_] = val_;
    }

    function setPayment(address paymentAddress_) external onlyOwner {
